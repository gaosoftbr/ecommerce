...
<div class="footer-bottom-area">
  <div class="container">
      <div class="row">
          <div class="col-md-8">
              <div class="copyright">
                  <p>&copy; 2023 Gaosoft. <a href="http://www.gaosoft.com.br" target="_blank">gaosoft.com.br</a></p>
              </div>
          </div>
...
<!-- jQuery sticky menu -->
<script src="/public/assets/web/js/owl.carousel.min.js"></script>
<script src="/public/assets/web/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="/public/assets/web/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="/public/assets/web/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="/public/assets/web/js/bxslider.min.js"></script>
<script type="text/javascript" src="/public/assets/web/js/script.slider.js"></script>
</body>
</html>